...
import type { NativeCompactionRuntime } from "./runtime.js";
import type { NativeCompactionRequestBody } from "./serializer.js";
import type { ArtifactContext, ExtensionSettings } from "./types.js";
...
export async function executeNativeCompaction(
	...
	try {
		...
		const success: NativeCompactionClientSuccess = {
			...
			compactResponseId:
				typeof parsed.id === "string" && parsed.id.trim() ? parsed.id.trim() : undefined,
